...
public enum HttpStatusCode {
    ...
    private static final Set<HttpStatusCode> ALL_CODES = EnumSet.allOf(HttpStatusCode.class);
    ...
    public static HttpStatusCode of(int code) {
        return ALL_CODES.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("No HttpResponseCode for " + code));
    }
